...
def test_openai_responses_agent_aliases():
    ...
    assert resolve_profile("qwable-review-agent", "openai_responses") == "review-workflow"


def test_anthropic_agent_aliases():
    assert resolve_profile("claude-qwable-agent", "anthropic_messages") == "agentic-workflow"
    assert resolve_profile("claude-qwable-code-agent", "anthropic_messages") == "coding-workflow"
    assert resolve_profile("claude-qwable-review-agent", "anthropic_messages") == "review-workflow"
